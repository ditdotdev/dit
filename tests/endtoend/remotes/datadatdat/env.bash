...
export DATADATDAT_API_KEY="${DATADATDAT_API_KEY:-***REMOVED***}"
...
if [[ "$ENV" == "PROD" ]]; then
  ...
  export DOWNLOAD_TEST_VERSION="${DOWNLOAD_TEST_VERSION:-v1.5.0}"
  ...
  export DOWNLOAD_TEST_VERSION="${DOWNLOAD_TEST_VERSION:-v1.6.1}"
