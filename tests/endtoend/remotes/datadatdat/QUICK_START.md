...
# Check if datadatdat CLI is built
which d3 || (cd datadatdat && make build)
```
...
docker exec datadatdat-postgres pg_isready -U datadatdat
...
- `tests/endtoend/remotes/datadatdat/README.md`
- `AUTH_IMPLEMENTATION.md`
- `DEPLOYMENT_GUIDE.md`

## Support

- **GitHub Issues**: Report problems at github.com/datadatdat/datadatdat
