...
The [dit install](../cli/cmd/dit_install.md) command will install supporting Dit infrastructure
automatically, including installing ZFS on the host or Docker VM if necessary.
The [dit uninstall](../cli/cmd/dit_uninstall.md) command will uninstall Dit, destroying any
...
the [dit context uninstall](../cli/cmd/dit_context_uninstall.md) command.
