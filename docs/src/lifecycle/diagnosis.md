...
Dit strives to present error messages in an easy-to-consume, readable
...
engaging with the [Community](https://dit.dev/community).

## Docker Logs

The most important tool in the diagnosis tool belt is to look at the
docker logs, specifically `docker logs dit`. This will show the
...
2019-09-30 16:18:28.530 [DefaultDispatcher-worker-6] DEBUG io.ditdata.util.CommandExecutor - Success: zfs, list, -Hpo, dev.dit:active, ditdotdev/repo/hello-world
2019-09-30 16:18:28.535 [DefaultDispatcher-worker-6] DEBUG io.ditdata.util.CommandExecutor - Success: zfs, list, -Ho, dev.dit:metadata, ditdotdev/repo/hello-world/2db7b743-d643-4861-82db-71682e2ada26/v0
...
2019-09-30 16:18:28.561 [DefaultDispatcher-worker-6] DEBUG io.ditdata.util.CommandExecutor - Success: zfs, list, -Hpo, dev.dit:active, ditdotdev/repo/hello-world
2019-09-30 16:18:28.640 [DefaultDispatcher-worker-6] DEBUG io.ditdata.util.CommandExecutor - Success: umount, /var/lib/ditdotdev/mnt/hello-world/v0
```
...
Sometimes the issue is not with dit, but with docker itself. For example,
...
discerned from the error message, try running with `DIT_DEBUG=true dit <cmd>`
