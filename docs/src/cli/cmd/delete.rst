...
commit. The commit must be present in `d3 log`. For more general information
...
::
    ...
    d3 delete -c <id> [-t key[=value] ...] <repository>
...
-c, --commit id         *Required*. Specify the commit ID to delete, or commit
                        ...
                        commit in `d3 log` for the given repository.
...
::
    ...
    $ d3 delete -c 7715327e95354263870ff5c92c18cb23 myrepo
    7715327e95354263870ff5c92c18cb23 deleted

    $ d3 delete -c 428f81caf63d4314b8f41a31aad2e8b1 -t mytag myrepo
